    ...
    public class ScFormulaLocationsFixture
    {
        public static FormulaLocation[] Locations = new FormulaLocation[]
        {
            new FormulaLocation
            {
                ...
                FairUseBookingPeriodEndDate = DateTime.Parse("2024-06-07T23:59:59.0000000Z"),
                FairUseBookingPeriodStartDate = DateTime.Parse("2024-06-01T00:00:00.0000000Z"),
                FairUseContactDate = DateTime.Parse("2024-06-03T23:59:59.0000000Z"),
            ...
            new FormulaLocation
            {
                ...
                EndDate = DateTime.Parse("2025-12-31T23:59:59.0000000Z"),
                FairUseBookingPeriodEndDate = DateTime.Parse("2024-06-17T23:59:59.0000000Z"),
                FairUseBookingPeriodStartDate = DateTime.Parse("2024-06-01T00:00:00.0000000Z"),
                FairUseContactDate = DateTime.Parse("2024-06-03T23:59:59.0000000Z"),
                FormulaType = "Fair-Use",
                LocationCode = "VA",
            ...
            new FormulaLocation
            {
                ...
                FairUseBookingPeriodEndDate = DateTime.Parse("2024-06-07T23:59:59.0000000Z"),
                FairUseBookingPeriodStartDate = DateTime.Parse("2024-06-01T00:00:00.0000000Z"),
                FairUseContactDate = DateTime.Parse("2024-06-01T23:59:59.0000000Z"),
                FormulaType = "Fair-Use",
                LocationCode = "CT",
                LocationID = 9,
            ...
            new FormulaLocation
            {
                ...
                FairUseBookingPeriodEndDate = DateTime.Parse("2024-06-17T23:59:59.0000000Z"),
                FairUseBookingPeriodStartDate = DateTime.Parse("2024-06-12T00:00:00.0000000Z"),
                FairUseContactDate = DateTime.Parse("2024-06-20T23:59:59.0000000Z"),
                FormulaType = "Fair-Use",
                LocationCode = "FJ",
                LocationID = 13,
            ...
            new FormulaLocation
            {
                ...
                BookingLocationID = 13,
                EndDate = DateTime.Parse("2024-07-31T23:59:59.0000000Z"),
                FairUseBookingPeriodEndDate = DateTime.Parse("2024-06-10T23:59:59.0000000Z"),
                FairUseBookingPeriodStartDate = DateTime.Parse("2024-06-01T00:00:00.0000000Z"),
                FairUseContactDate = DateTime.Parse("2024-06-20T23:59:59.0000000Z"),
                FormulaType = "Fair-Use",
                LocationCode = "FJ",
