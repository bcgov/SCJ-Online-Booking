...
namespace SCJ.Booking.MVC.Services
{
    public class HearingsLeft
    {
        ...
        private int GetUserHearingsTotalLeft()
        {
            ...
            //get user GUID
            string uGuid = "b17a483a-0012-4bd1-8a55-44c8c20bf8e8";
            ...
            //booked on today
            var hearingsBookedForToday = _dbContext.BookingHistory.Where(b => b.SmGovUserGuid == uGuid &&  b.Timestamp == todaysDate).ToList();
