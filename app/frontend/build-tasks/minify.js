 ...
 * @param {boolean} [generateMap=true] - Optional flag to generate source maps. If true, creates a .min.js.map file
 ...
 * Source maps are generated by default to aid in debugging.
 *
 * @example
 * // Minify a file to the default location (wwwroot/dist/minified/) with source map
 * await minifyJs('js/site');
 *
 * @example
 * // Minify a file to a custom output directory within wwwroot with source map
 * await minifyJs('dist/lib/jquery.spin', 'dist/lib');
 *
 * @example
 * // Minify a file without generating source map
 * await minifyJs('js/site', null, false);
 */
async function minifyJs(relativePath, outputDirOverride, generateMap = true) {
